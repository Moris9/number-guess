  ...
  return (
    ...
    <meta name="googlebot" content="noindex" />
      <Row className="text-center mx-auto pt-2 pb-2" style={{ width: "300px" }}>
        <a className="privateBtn" style={{ width: "130px" }} href="/">
          Number Guess
        </a>
        <a
      ...
      <Row className="text-start mx-auto" style={{ maxWidth: "1000px" }}>
        <p>
          At Number Guess, accessible from https://www.numberguess.org/,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by Number Guess and how we use it. If you have
          ...
          Number Guess. This policy is not applicable to any information
        ...
        <p>
          Number Guess's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ...
          Number Guess does not knowingly collect any Personal Identifiable
